...
describe("média móvel de 7 dias", () => {
  it("suaviza o ruído diário", () => {
    ...
    // depois da janela encher, a tendência oscila muito menos que o peso bruto
  ...
  it("os primeiros dias usam a janela parcial disponível", () => {
    const w: WeightEntry[] = [
      { d: "2026-01-01", kg: 90 }, { d: "2026-01-02", kg: 92 },
    ];
    const t = tendencia(w);
...
describe("ritmo semanal", () => {
  ...
  it("reconhece estagnação", () => {
    const r = ritmoSemanal(serie(45, 91, 0));
