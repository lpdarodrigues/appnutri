      ...
      <div className="card px-4 py-3.5">
        <div className="text-[13px] leading-relaxed text-[#4A5763]">
          ...
          <span className="num text-[11px] text-dim">
            {n(st.foods.length, "rótulo seu", "rótulos seus")} ·{" "}
            {n(st.diets.length, "dieta", "dietas")} ·{" "}
            {n(st.weights.length, "pesagem", "pesagens")} ·{" "}
            {n(Object.keys(st.days).length, "dia registrado", "dias registrados")}
          </span>
        </div>
      </div>
    </div>
